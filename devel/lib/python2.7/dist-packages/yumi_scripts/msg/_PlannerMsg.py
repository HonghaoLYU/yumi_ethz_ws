...
"""autogenerated by genpy from yumi_scripts/PlannerMsg.msg. Do not edit."""
import sys
...
class PlannerMsg(genpy.Message):
  _md5sum = "9f8ec11ef8e7dcdf8910f6642b4e486c"
  _type = "yumi_scripts/PlannerMsg"
...
duration time_from_start
"""
  __slots__ = ['group_name','start_state','trajectory','total_plans','associated_module_name']
  _slot_types = ['string','moveit_msgs/RobotState','moveit_msgs/RobotTrajectory[]','uint32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       group_name,start_state,trajectory,total_plans,associated_module_name
    ...
    """
    if args or kwds:
      super(PlannerMsg, self).__init__(*args, **kwds)
      ...
      if self.trajectory is None:
        self.trajectory = []
      if self.total_plans is None:
        self.total_plans = 0
      if self.associated_module_name is None:
        self.associated_module_name = ''
    else:
      self.group_name = ''
      self.start_state = moveit_msgs.msg.RobotState()
      self.trajectory = []
    ...
    try:
      ...
      for val1 in self.trajectory:
        ...
        for val3 in _v25.points:
          ...
          _x = _v34
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      buff.write(_get_struct_I().pack(self.total_plans))
      _x = self.associated_module_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.total_plans,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.associated_module_name = str[start:end].decode('utf-8')
      else:
        self.associated_module_name = str[start:end]
      return self
