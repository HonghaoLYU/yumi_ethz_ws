...
"""autogenerated by genpy from yumi_scripts/ModuleDataMsg.msg. Do not edit."""
import sys
...
class ModuleDataMsg(genpy.Message):
  _md5sum = "1a67dafea575532d17cc4f00f410a69f"
  _type = "yumi_scripts/ModuleDataMsg"
...
float64 w
"""
  __slots__ = ['group_name','pose_names','pose_configs','gripper_attached','total_points']
  _slot_types = ['string','string[]','yumi_scripts/PoseConfigMsg[]','bool','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       group_name,pose_names,pose_configs,gripper_attached,total_points
    ...
    """
    if args or kwds:
      super(ModuleDataMsg, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.group_name is None:
        self.group_name = ''
      if self.pose_names is None:
        self.pose_names = []
      if self.pose_configs is None:
        self.pose_configs = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.pose_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.pose_configs)
      buff.write(_struct_I.pack(length))
      for val1 in self.pose_configs:
        _x = val1.group_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_BI().pack(_x.gripper_attached, _x.total_points))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.pose_configs.append(val1)
      _x = self
      start = end
      end += 5
      (_x.gripper_attached, _x.total_points,) = _get_struct_BI().unpack(str[start:end])
